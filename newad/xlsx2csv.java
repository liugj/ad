...
public class xlsx2Csv {
     ...
     */
    public xlsx2Csv(OPCPackage pkg, StringBuilder output, int minColumns) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            xlsx2Csv xlsx2Csv = new xlsx2Csv(p, stringBuilder, minColumns);
            xlsx2Csv.process();
     ...
     * @throws SAXException if parsing the XML data fails.
     */
    public void process() throws IOException, OpenXML4JException, SAXException, ParserConfigurationException {
